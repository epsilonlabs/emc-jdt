...
/**
 * This is the dialogue for JDT model configuration. It provides five features
 * (the first two are inherited from the super class):
 * <p>
 * 1. setting the model name;
 * <p>
 * 2. setting the alias;
 * <p>
 * 3. selecting the projects to be parsed.
 * <p>
 * 4. selecting the mode cache type (how the model will be stored).
 * <p>
 * 5. turn Reslove Bindings on/off.
 * <p>
 * 
 * @author Cheng Yun
 * 
